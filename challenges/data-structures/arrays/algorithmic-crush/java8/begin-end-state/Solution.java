...
public class Solution {
    ...
    */
    ...
    // Keeps track of the running state by delta markers at each operation effect zone
    private static long[] operationStates;
    ...
    */
    private static void add(int a, int b, int val) {
        operationStates[a] += val;
        if (b < operationStates.length) {
            operationStates[b] -= val;
        }
    }
